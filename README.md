...
| | |
|---|---|
| ![](screenshots/01_salary_city.png) | ![](screenshots/02_salary_age.png) |
| Средняя зарплата по городам | Зарплата по возрасту |
| ![](screenshots/03_salary_gender.png) | ![](screenshots/04_salary_education.png) |
| Зарплата по полу | Зарплата по образованию |
